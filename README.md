...
O MD Gestão Enterprise foi criado justamente para centralizar essas informações, eliminando processos manuais e devolvendo o controle do negócio ao empreendedor.
...
*   **Python 3.012:** Linguagem base para a lógica de negócio.
*   **SQLite:** Banco de dados relacional.
*   **Pandas:** Manipulação de dados e relatórios.
*   **Plotly:** Gráficos interativos.
*   **FPDF:** Geração de comprovantes em PDF.

---

## Desenvolvedor/Analista
Desenvolvido por **Thaina Panaino**.
